...
NDiplomacy = {
	...
	TRADE_LEAGUE_MIN_PRESTIGE_NEW_LEADER = 25,		-- Minimum required prestige to become the new leader of a Trade League when the old one is resigned.
	TRADE_LEAGUE_BREAK_OPINION = -10,				-- AI will leave a Trade League if their opinion of you falls below this value.
	...
	AUTONOMY_WARSCORE_COST_MODIFIER = 0.15,			-- How much autonomy reduces score by (at 1, 50% autonomy = 50% reduction)
	...
	COUNTERESPIONAGE_DISCOVER_CHANCE = 0.4,
	...
	SUPPORT_REBELS_MONEY_FACTOR = 0.3,
	...
	PEACE_COST_BECOME_VASSAL = 1.5,					-- Vassalize a country (scales by province wealth)
	...
	PEACE_COST_CHANGE_GOVERNMENT = 90, 				-- _Peace cost for changing government form
	PEACE_COST_TRADE_POWER = 30, 					-- Peace cost for demanding trade power
	PEACE_COST_STEER_TRADE = 60,					-- Peace cost for steering trade
	PEACE_COST_INDEPENDANCE = 40, 					-- Peace cost for breaking free of union
	...
	PEACE_COST_GIVE_UP_CLAIM = 5,					-- Peace cost for giving up all claims in a country
	...
	PEACE_COST_DEMAND_CAPITAL_MULT = 1.75,
	...
	ANNEX_DIP_COST_PER_DEVELOPMENT = 12,			-- per development
	...
	DIPLOMAT_SPEED = 15.0,							-- DIPLOMAT_SPEED
	...
	INTEGRATE_UNION_MIN_YEARS = 60,					-- Number of years before a union can be integrated
	INTEGRATE_VASSAL_MIN_YEARS = 20,				-- Number of years before a vassal can be integrated
	...
	ABANDON_UNION_PRESTIGE = -75,					-- The change in prestige for the overlord when abandoning a personal union.

	PAY_SUBJECT_DEBT_LIBERTY_DESIRE_REDUCTION = 2,	-- Amount of liberty desire the subject loses per paid loan

	NUM_OF_GREAT_POWERS = 8,						-- The number of ordinary (i.e. non-leaving) Great Powers if RightsOfManDLC is enabled.
	LEAVING_GREAT_POWER_YEARS = 3,					-- The number of years a Great Power can remain after being removed from the top (8).
	...
	FORCE_END_RIVALRY_YEARS = 25,					-- Years until you can re-add a Rival after being forced to remove them by peace treaty.
...
NCountry = {
	...
	STATE_MAINTENANCE_CONTINENT_FACTOR = 0.3,	-- different continet
	...
	VICTORY_CARD_DECAY_MONTHS = 1,		-- months to lose all score.
	VICTORY_CARD_INCREASE_MONTHS = 1,		-- months to gain all score.
	...
	CORE_LOSE = 75, 								-- how many years until a core is lost.
	...
	LAGGINGTECH_CORRUPTION = 0.15,					-- Corruption increase/year. Multiplied by (highest - lowest) tech level
	LAGGINGTECH_CORRUPTION_MAX = 0.75,				-- Max increase/year
	...
	STARTING_ARMY_SIZE_REBEL_THREAT = 0.10,			-- Percentage of rebel threat added to percentage of force limit
	...
	LIBERTY_DESIRE_GREAT_POWER_VASSAL = 35,			-- Liberty desire from vassal having more than 300 development
	...
	LIBERTY_DESIRE_DEVELOPED_IN_SUBJECT = -2,   	-- Liberty desire decrease from overlord developing province in subject.
	...
	PLACATE_RULERS_PRESTIGE = -10,
	PLACATE_RULERS_LIBERTY = -5,
	RELATIVE_ON_THRONE_LIBERTY = 15,
...
NEconomy = {
	EDICTS_COST_INCREASE = 1.25,				-- % increase on state maintenance.
	...
	AUTONOMY_AT_CONQUEST = 90,						-- Autonomy added at conquest
	AUTONOMY_AT_CONQUEST_CLAIM = 75,				-- Autonomy added at conquest if you have a claim
	AUTONOMY_AT_CONQUEST_CORE = 25,					-- Autonomy added at conquest if you have a core
...
NMilitary = {
	...
	FORT_DEVASTATION_IMPACT = -2,				-- multiplied by fortlevel/max fortlevel in area per year.
	...
	DEVASTATION_DEVELOPMENT_SCALE = 1,


	PARTICIPATION_SCORE_BLOCKADE = 0.002,			-- Per development & ship, once each month
	...
	MOVE_LOCK_PERCENTAGE = 0.4,						-- Unit movement is locked after this percentage of progress
	...
	SIEGE_ATTRITION = 1,
	SIEGE_DISEASE_IMPACT = 0.15,						-- Fraction of besieging soldiers lost in a disease outbraek
	...
	MERCENARY_BASE_COST = 15.0,					-- base cost added for a mercenary regiment
	...
	CONDOTTIERI_TRADITION_BONUS = 0.85,				-- This modifies army tradition gained from fighting with condottieris
...
NAI = {
	...
	POWERFUL_ALLY_PENALTY = 30,	-- Penalty on alliance for them already having a powerful ally if much stronger
	RIVAL_ALLIANCE_PENALTY = 150, -- Penalty on alliance chance for being allied to rivals
	...
	PEACE_TERMS_PROVINCE_NOT_CULTURE_MULT = 0.25, -- AI desire for a province is multiplied by this if it is not the same culture
